...
import { validateTypedSignMessageDataV3, validateTypedSignMessageDataV1 } from './utils';
 ...
 */
export class TypedMessageManager extends AbstractMessageManager<TypedMessage, TypedMessageParams, TypedMessageParamsMetamask> {
  /**
