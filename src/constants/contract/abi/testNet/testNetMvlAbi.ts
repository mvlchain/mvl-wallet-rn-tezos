export const testNetMvlAbi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_value', type: 'uint256' },
      { name: '_release_time', type: 'uint256' },
    ],
    name: 'addTokenLock',
    outputs: [],
    payable: false,
  ...
  { constant: false, inputs: [], name: 'unlockAllTokens', outputs: [], payable: false, stateMutability: 'nonpayable', type: 'function' },
  {
    constant: false,
    inputs: [
      { name: '_spender', type: 'address' },
