...
export default {
  ...
  HOMEPAGE_URL: process.env.MM_HOMEPAGE || 'http://192.168.1.56:3000/',
  ...
  URLS: {
    ...
    DATA_RETENTION_UPDATE: 'https://consensys.net/blog/news/consensys-data-retention-update/',
    ...
    SECURITY: 'https://metamask.zendesk.com/hc/en-us/articles/360015489591-Basic-Safety-and-Security-Tips-for-MetaMask',
    TOKEN_BALANCE:
    ...
    WHY_TRANSACTION_TAKE_TIME: 'https://community.metamask.io/t/what-is-gas-why-do-transactions-take-so-long/3172',
  },
  ERRORS: {
  ...
  REVIEW_PROMPT: {
    ...
    MISSING_TOKENS: 'https://metamask.zendesk.com/hc/en-us/articles/360015489031-How-to-add-unlisted-tokens-custom-tokens-in-MetaMask',
