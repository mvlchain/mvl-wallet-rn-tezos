 ...
 */
export default function onUrlSubmit(input: any, searchEngine = 'Google', defaultProtocol = 'https://') {
 ...
 */
export function getHost(url: any, defaultProtocol = 'https://') {
 ...
 */
export function getUrlObj(url: any) {
 ...
 */
export const isTLD = (hostname: any, error: any) =>
  (hostname.slice(-4) !== '.eth' && error.toString().indexOf('is not standard') !== -1) ||
